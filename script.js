...
class Factory {
  constructor(){
    ...
    this.airbags = true
    this.abs = true
    this.warranty = '60000 miles / 3 years'
...
let yellowmazda3 = new Car('mazda3',4,'yellow','hybrid','automatic','touring','base','premium','leather',true)
let optyellowmaz3 = ['weather package', 'satellite radio', 'rear spoiler']
console.log(mazda3.customerBuild(yellowmazda3,optyellowmaz3))
...
let blackmiata = new Sport('miataRf','grand touring','black','hybrid','black','base','premium','leather',true)
let optblackmiata = ['hid headlights','sports suspension', 'leather steering wheel', 'heated seats', 'adaptive cruise control']
console.log(blackmiata.customerBuild(blackmiata,optblackmiata))
...
//(model, color, enginesize, hitch, bed, navigation)
...
// Write your code below:
//(model, color, enginesize, hitch, bed, navigation,trim)

let redtb = new Truck('trail blazer','red',8,true,'standard',true,'sport')
let optredtb = ["seat warmers", "tinted windows", "fog lamps"]
console.log(redtb.customerBuild(redtb,optredtb))
